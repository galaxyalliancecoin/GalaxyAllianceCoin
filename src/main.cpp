...
int64 nChainStartTime = 1543804234;
...
const string strMessageMagic = "GalaxyAllianceCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GalaxyAllianceCoin
    bool fStrictPayToScriptHash = true; // Always active in GalaxyAllianceCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GalaxyAllianceCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "GalaxyAllianceCoin 1.0.0, 2018.Wish a great Coin!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x58d8792ca37de5d32583f6dab2e58134d35d11791504c5507d069730647e2cea"));
...
unsigned char pchMessageStart[4] = { 0x4a, 0xd5, 0xda, 0x5c };
