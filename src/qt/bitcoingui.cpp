...
{
    resize(850, 550);
    setWindowTitle(tr("GalaxyAllianceCoin"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GalaxyAllianceCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/coin"), tr("&About GalaxyAllianceCoin"), this);
    aboutAction->setToolTip(tr("Show information about GalaxyAllianceCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for GalaxyAllianceCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GalaxyAllianceCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GalaxyAllianceCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GalaxyAllianceCoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GalaxyAllianceCoin address or malformed URI parameters."));
    }
